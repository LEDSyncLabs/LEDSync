...
std::unordered_map<adc2_channel_t, Potentiometer::Listener> Potentiometer::listeners;
...
void Potentiometer::addListener(adc2_channel_t channel, Callback callback, int intervalMs) {
    if (adc_evt_queue != NULL) {
